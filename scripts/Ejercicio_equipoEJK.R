...
#Â¿Podemos encontrar hojas aparentemente demasiado anchas para su longitud?

#grafico de dispersion#
scatterplot(log10(data2$width.leaf.cm) ~ log10(data2$length.leaf.cm))
#Para ver a que especies correspondeb los puntos extraÃ±os le ponemos etiquetas
#con ggplot
